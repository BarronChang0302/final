...
void BBCar::twoSpeed( double speed1, double speed2 ){
    servo0.set_factor(1);
    servo1.set_factor(0.87);
    servo0.set_speed(speed1);
    servo1.set_speed(speed2);
}
